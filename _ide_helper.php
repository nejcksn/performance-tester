...
namespace  {
             ...
             */            public static function clone()
            {
                            ...
                            /**
             * Chunk the test_results of the query.
             *
             * @param int $count
             * @param callable $callback
             * @return bool
             ...
             */            public static function each($callback, $count = 1000)
            {
                            ...
                            /**
             * Chunk the test_results of a query by comparing IDs.
             *
             * @param int $count
             * @param callable $callback
             ...
             */            public static function chunkById($count, $callback, $column = null, $alias = null)
            {
                            ...
                            /**
             * Chunk the test_results of a query by comparing IDs in descending order.
             *
             * @param int $count
             * @param callable $callback
             * @param string|null $column
             ...
             */            public static function chunkByIdDesc($count, $callback, $column = null, $alias = null)
            {
                            ...
                            /**
             * Chunk the test_results of a query by comparing IDs in a given order.
             *
             * @param int $count
             * @param callable $callback
             * @param string|null $column
             ...
             */            public static function lazy($chunkSize = 1000)
            {
                            ...
                            /**
             * Query lazily, by chunking the test_results of a query by comparing IDs.
             *
             * @param int $chunkSize
             * @param string|null $column
             * @param string|null $alias
             ...
             */            public static function lazyById($chunkSize = 1000, $column = null, $alias = null)
            {
                            ...
                            /**
             * Query lazily, by chunking the test_results of a query by comparing IDs in descending order.
             *
             * @param int $chunkSize
             * @param string|null $column
             * @param string|null $alias
             ...
             */            public static function addSelect($column)
            {
                            ...
                            /**
             * Force the query to only return distinct test_results.
             *
             * @return \Illuminate\Database\Query\Builder
             * @static
             ...
             */            public static function orderByDesc($column)
            {
                            ...
                            /**
             * Put the query's test_results in random order.
             *
             ...
             */            public static function forPage($page, $perPage = 15)
            {
                            ...
                            /**
             * Constrain the query to the previous "page" of test_results before a given ID.
             *
             * @param int $perPage
             ...
             */            public static function forPageBeforeId($perPage = 15, $lastId = 0, $column = 'id')
            {
                            ...
                            /**
             * Constrain the query to the next "page" of test_results after a given ID.
             *
             * @param int $perPage
             * @param int|null $lastId
             * @param string $column
